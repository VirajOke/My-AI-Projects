# -*- coding: utf-8 -*-
"""pretrained_transformers_1 (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KR9Dn00vlefEJo6heTl03sKla722Qgu8

# Sentiment analysis using pre-trained deep learning models 
Testing transformer models

Uses our ETL functions to load docx, html etc. documents to Python text strings, then runs different sentiment analysis transformer models on the documents and displays the results.
"""
...
"""## Experiment block for different transformer models
- To make this block work, temporarily  add an argument `model_name` in `get_sentimet()`
